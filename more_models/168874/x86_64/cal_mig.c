...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal /home/trundle/Projects/NST-variation/more_models/ca1dDemo/cal_mig.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  state();
 if(error){fprintf(stderr,"at line 67 in file cal_mig.mod:\n  SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/trundle/Projects/NST-variation/more_models/ca1dDemo/cal_mig.mod";
static const char* nmodl_file_text = 
